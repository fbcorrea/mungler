...
def save_to_chroma(chunks: list[Document]):
    ...
    db = Chroma.from_documents(chunks,SentenceTransformerEmbeddings(model_name="all-mpnet-base-v2"),persist_directory=CHROMA_PATH)
    db.persist()
...
def main():
    ...
    #with open('data/alice_in_wonderland_SMALLER.md', 'r', encoding='utf-8') as file:
    #    context_text = file.read()
    
    context_text = "Alice drank from a bottle and shrank"    
